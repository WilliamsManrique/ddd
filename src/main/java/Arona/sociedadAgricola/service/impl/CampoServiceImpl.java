...
import Arona.sociedadAgricola.model.Campo;
import Arona.sociedadAgricola.repository.CampoRepository;
import Arona.sociedadAgricola.service.CampoService;
...
public class CampoServiceImpl implements CampoService {
    ...
    public Campo editar(Long id, Campo datos) {
        return campoRepository.findById(id).map(campo -> {
            ...
            campo.setTipoCultivo(datos.getTipoCultivo());
